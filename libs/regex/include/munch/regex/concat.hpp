#ifndef MUNCH_LIBS_REGEX_INCLUDE_MUNCH_REGEX_CONCAT_HPP
#define MUNCH_LIBS_REGEX_INCLUDE_MUNCH_REGEX_CONCAT_HPP
...
#endif // MUNCH_LIBS_REGEX_INCLUDE_MUNCH_REGEX_CONCAT_HPP
