...
cutting before a newline conditional on the preceding byte being \code{)}, could recover splitting for some grammars
where no single byte certifies. A hybrid plan could split at certified bytes where they exist and fall back to
